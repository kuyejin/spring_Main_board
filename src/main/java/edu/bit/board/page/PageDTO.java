...
public class PageDTO {
	...
	private boolean prev, next; //이전과 다음 으로 이동가능한 링크 표시		
	...
	//현재 페이지 정보로 부터 끝페이지애 대한 연산    / 10.0)) * 10; 나누기 숫자와 곱하기 숫자는 같아야 한다
	//ex) cri.getPageNum() = 3; 
	//하단 페이징 바에 보여줄 페이징바 개수
	//연산: ceil(3/10.0) * 10 => 1* 10 = 10까지 (ceil은 올림)
	...
	//cri.getAmount()
	//ceil(512/ 10.0) = 52
	//51.2의 결과를 올임 => 51페이지까지는 한화면당 10개의 게시물이 출력
